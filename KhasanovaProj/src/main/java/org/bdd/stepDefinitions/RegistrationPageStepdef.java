...
public class RegistrationPageStepdef extends MainSteps{
    public RegistrationPageStepdef(WebDriverHelper webDriverHelper) {
    ...
    public void i_see_on_login_page(String string) {
        pageProvider.getLoginPage().checkErrorsMessage(string);
    }
}
