...
public class WebDriverHelper {
    ...
    public WebDriverHelper() {
        if (webDriver == null) { //сюди приходить пікоконтейнер і дивиться, чи є об'єкт класу WebDriverHelper
            webDriver = initDriver(); //якщо об'єкт ще не створений, то створюємо його
                                      //якщо об'єкт вже створений, то initDriver() не викликається
        }
    }
