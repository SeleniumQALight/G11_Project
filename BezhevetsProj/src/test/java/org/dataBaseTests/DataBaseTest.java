...
public class DataBaseTest {
    ...
    public void tearDownDB() throws SQLException {
        mySQLDataBase.quit();
        logger.info("My SQL database connection was closed");
    }
    ...
    public void testDataFromDB() throws SQLException, ClassNotFoundException {
        ...
        final String LOGIN = "G11_Vlad_Bzh_new";
        ...
        int numberOfEffectedRows = mySQLDataBase.changeTable("INSERT INTO seleniumTable VALUES('404','%s','%s')", LOGIN, "12345");
