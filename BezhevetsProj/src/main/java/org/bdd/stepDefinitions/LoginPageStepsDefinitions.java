...
public class LoginPageStepsDefinitions extends MainSteps {
    ...
    public void i_enter_into_input_login_in_login_page(String string) {
        pageProvider.getLoginPage().enterTextIntoInputLogin(string);
    }
    @When("I enter {string} into input PassWord in Login page")
    public void i_enter_into_input_pass_word_in_login_page(String string) {
        pageProvider.getLoginPage().enterTextIntoInputPassword(string);
    }
