...
public class DataBaseTest {
    ...
    public void setUpDB() throws SQLException, ClassNotFoundException {
        mySQLDataBase = MySQL_Database.getDataBase(); //встановили connection
        logger.info("MySQL database was setup");
    }

    @After
    public void tearDownDB() throws SQLException{
        mySQLDataBase.quit(); //обов'язково закрити connection!
    ...
    public void testDataFromDB() throws SQLException, ClassNotFoundException {
        ...
        int numberOfEffectedRows = mySQLDataBase.changeTable(
                "INSERT INTO seleniumTable VALUES('104','%s','%s')", LOGIN, "12345");
        ...
        int numberOfDeletedRows = mySQLDataBase.changeTable(
