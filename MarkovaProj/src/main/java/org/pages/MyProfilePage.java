...
public class MyProfilePage extends ParentPage {
    ...
    public MyProfilePage deletePostsTillPresent(String postTitle) {
        ...
        while (!postsList.isEmpty() && (counter < MAX_POST_COUNT)) {
            ...
            new PostPage(webDriver).checkIsRedirectOnPostPage().clickOnDeleteButton().
                    checkIsRedirectToProfilePage().checkIsMessageDeletePresent();
    ...
    private MyProfilePage checkIsMessageDeletePresent() {
